...
public class MovieServiceImpl implements MovieService {
    ...
    public void getPopularMovies(final TMDBClient.APICallback apiCallback) {
        Call<MovieResults> call = client.obtainPopularMovies(GeneralAPIData.API_KEY);
        call.enqueue(new Callback<MovieResults>() {
            ...
            public void onResponse(Call<MovieResults> call, Response<MovieResults> response) {
                ...
                for (MovieResultsItem movieResultsItem : movieResults.getResults()) {
                    ...
                    String url = GeneralAPIData.getInstance().getImgBaseUrl();
                    url += GeneralAPIData.getInstance().getPosterSizes().get(0);
